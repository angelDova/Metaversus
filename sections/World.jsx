  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        {/* <div className="absolute top-1/2 right-[45%] w-[70px] p-[6px] rounded-full bg-[#5d6680}">
          <img src="map1.png" alt="map" className="w-full h-full" />
        </div>
        <div className="absolute top-20 left-[45%] w-[70px] p-[6px] rounded-full bg-[#5d6680}">
          <img src="map2.png" alt="map" className="w-full h-full" />
        </div> */}
      </motion.div>
    </motion.div>
  </section>
